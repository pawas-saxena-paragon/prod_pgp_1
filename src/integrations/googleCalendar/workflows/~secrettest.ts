...
/**
 * secretTest Workflow implementation
 */
...
> {
  ...
  define(
    ...
    const functionStep = new FunctionStep({
      ...
      parameters: {
        parameter_name: context.getEnvironmentSecret('demSecret1'),
      },
    });
   ...
   */
  readonly id: string = '931bd034-5a4d-4669-8ad1-5f634c5dcd7c';
}
